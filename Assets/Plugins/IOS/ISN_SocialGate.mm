...
const char* FACEBOOK_LISTENER = "SA.IOSNative.Social.Facebook+NativeListener";
const char* TWITTER_LISTENER = "SA.IOSNative.Social.Twitter+NativeListener";
const char* INSTAGRAM_LISTENER = "SA.IOSNative.Social.Instagram+NativeListener";
const char* MAIL_LISTENER = "SA.IOSNative.Social.Mail+NativeListener";
const char* TEXT_MESSAGE_LISTENER = "SA.IOSNative.Social.TextMessage+NativeListener";
...
-(void) twitterPost:(NSString *)status url:(NSString *)url imagesList:(NSArray<NSString *> *)imagesList; {
    ...
    if(tweetSheet == NULL) {
        ...
        UnitySendMessage(TWITTER_LISTENER, "OnTwitterPostFailed", [ISN_DataConvertor NSStringToChar:@""]);
        return;
    }
    ...
    tweetSheet.completionHandler = ^(SLComposeViewControllerResult result) {
        ...
        switch(result) {
            ...
            case SLComposeViewControllerResultDone:
                ...
                UnitySendMessage(TWITTER_LISTENER, "OnTwitterPostSuccess", [ISN_DataConvertor NSStringToChar:@""]);
                break;
        }
    };
}
...
- (void) fbPost:(NSString *)status url:(NSString *)url imagesList:(NSArray<NSString *> *)imagesList {
    ...
    if(fbSheet == NULL) {
        ...
        UnitySendMessage(FACEBOOK_LISTENER, "OnFacebookPostFailed", [ISN_DataConvertor NSStringToChar:@""]);
        return;
    }
    ...
    fbSheet.completionHandler = ^(SLComposeViewControllerResult result) {
        ...
        switch(result) {
            ...
            case SLComposeViewControllerResultDone:
                ...
                [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"ISN: Done pressed successfully"];
                UnitySendMessage(FACEBOOK_LISTENER, "OnFacebookPostSuccess", [ISN_DataConvertor NSStringToChar:@""]);
                break;
        }
...
- (void) sendEmail:(NSString *)subject body:(NSString *)body recipients:(NSArray<NSString *> *)recipients imagesList:(NSArray<NSString *> *)imagesList {
    ...
    if(emailDialog == nil) {
        UnitySendMessage(MAIL_LISTENER, "OnMailFailed", [ISN_DataConvertor NSStringToChar:@""]);
        return;
    }
...
- (void) mailComposeController:(MFMailComposeViewController *)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError *)error {
    switch (result)
    {
        ...
        case MFMailComposeResultSent:
            UnitySendMessage(MAIL_LISTENER, "OnMailSuccess", [ISN_DataConvertor NSStringToChar:@""]);
...
- (void) sendTextMessagel:(NSString *)body recipients:(NSArray<NSString *> *)recipients imagesList:(NSArray<NSString *> *)imagesList {
    ...
    if([MFMessageComposeViewController canSendText]) {
        ...
        UnitySendMessage(TEXT_MESSAGE_LISTENER, "OnTextMessageComposeResult", "3");
    }
...
- (void)messageComposeViewController:(MFMessageComposeViewController *)controller didFinishWithResult:(MessageComposeResult)result {
    ...
    UnitySendMessage(TEXT_MESSAGE_LISTENER, "OnTextMessageComposeResult", [ISN_DataConvertor NSIntToChar:result]);
}
...
-(void) share:(NSString *)status media:(NSString *)media {
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 5.0) {
        ...
        UnitySendMessage(INSTAGRAM_LISTENER, "OnInstaPostFailed", [ISN_DataConvertor NSStringToChar:@"3"]);
        ...
        if ([MGInstagram isAppInstalled]) {
            ...
            UnitySendMessage(INSTAGRAM_LISTENER, "OnInstaPostFailed", [ISN_DataConvertor NSStringToChar:@"1"]);
...
- (void)documentInteractionControllerDidDismissOpenInMenu:(UIDocumentInteractionController *)controller {
    ...
    UnitySendMessage(INSTAGRAM_LISTENER, "OnInstaPostFailed", [ISN_DataConvertor NSStringToChar:@"2"]);
...
- (void) documentInteractionController: (UIDocumentInteractionController *) controller willBeginSendingToApplication: (NSString *) application {
    ...
    UnitySendMessage(INSTAGRAM_LISTENER, "OnInstaPostSuccess", [ISN_DataConvertor NSStringToChar:@""]);
...
extern "C" {
    ...
    void _ISN_FbPost(char* text, char* url, char* encodedMedia) {
        NSArray* imagesList = [ISN_DataConvertor charToNSArray:encodedMedia];
        [[ISN_SocialGate sharedInstance] fbPost:[ISN_DataConvertor charToNSString:text] url:[ISN_DataConvertor charToNSString:url] imagesList:imagesList];
    }
    ...
    void _ISN_TwPost(char* text, char* url, char* encodedMedia) {
        NSArray* imagesList = [ISN_DataConvertor charToNSArray:encodedMedia];
        [[ISN_SocialGate sharedInstance] twitterPost:[ISN_DataConvertor charToNSString:text] url:[ISN_DataConvertor charToNSString:url] imagesList:imagesList];
    }
    ...
    void _ISN_SendMail(char* subject, char* body,  char* recipients, char* encodedMedia) {
        ...
        NSArray* mailRecipients = [ISN_DataConvertor charToNSArray:recipients];
        NSArray* imagesList = [ISN_DataConvertor charToNSArray:encodedMedia];
